...
public class DatabaseHelper extends SQLiteOpenHelper {
    public static String DATABASE_NAME = "db_android";
    private static final int DATABASE_VERSION = 1;
    private static final String TABLE_STUDENTS = "students";
    private static final String KEY_ID = "id";
    private static final String KEY_FIRSTNAME = "name";
    public static final String  URL_ADD = "http://192.168.1.4/pegawai/tambahpgw.php";
    public static final String  URL_GET_ALL = "http://192.168.1.4/pegawai/tampilsemuapgw.php";
    public static final String  URL_GET_EMP = "http://192.168.1.4/pegawai/tampilpgw.php?id=";
    public static final String  URL_UPDATE_EMP = "http://192.168.1.4/pegawai/updatepgw.php";
    public static final String  URL_DELETE_EMP = "http://192.168.1.4/pegawai/hapuspgw.php?id=";
